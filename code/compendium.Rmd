...
Involves switching high-low pairs between conditions.

```{r fig.height=25, fig.width=7}

if(file.exists("../data/simulation_condition_switching.rds")){
  
  simulation_condition_switching <- read_rds("../data/simulation_condition_switching.rds")
  ...
  write_rds(simulation_condition_switching, "../data/simulation_condition_switching.rds", compress = "gz")
...
data_summary_ordered <- simulation_condition_switching_summary |>
  # the outcome variable must be called `outcome`
  # eg the estimand of your simulation, whether the false positive rate, estimated effect size, etc.
  # replace `positive_rate` with
  mutate(outcome = altered_data_false_positive_rate) |>
...
Involves changing most extreme values, but not switching per se.

```{r fig.height=25, fig.width=7}

if(file.exists("../data/simulation_condition_changing.rds")){
  
  simulation_condition_switching <- read_rds("../data/simulation_condition_changing.rds")
