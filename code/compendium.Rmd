...
data_summary_ordered <- simulation_unwarranted_data_exclusion_summary |>
  ...
  dplyr::select(`N dropped` = n_participants_dropped_per_condition, 
...
ggsave(filename = "exclusions.pdf",
       plot = p_multiverse,
       device = "pdf",
       width = 6,
       height = 5)
...
data_summary_ordered <- simulation_condition_switching_summary |>
  ...
  mutate(n_participants_swapped_per_condition = as.factor(n_participants_swapped_per_condition),
         n_per_condition = as.factor(n_per_condition)) |>
  dplyr::select(`N swapped` = n_participants_swapped_per_condition, 
                `N participants` = n_per_condition,
                outcome,
                rank) 
